using MediaPlayer.Views.Categorization;
using MediaPlayer.Views.MediaLists;
using MediaPlayer.Views.MediaLists.Cards;
using MediaPlayer.Views.VideoPlayer;
...
namespace MediaPlayer.Helper.Navigation
{
    internal class NavigationManager: INavigationManager
    {
        ...
        public  void OpenMovie(Movie movie, Func<IEnumerable<BaseModel>> GetCollectionElements)
        {
            var navigationParameter = new Dictionary<string, object>
            {
                { "Movie", movie }
