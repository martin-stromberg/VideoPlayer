...
namespace VideoPlayer.ViewModels.MediaLists.Details
{
    public class MovieDetailsViewModel : BaseDetailsViewModel
    {
        ...
        {
            get { return GetProperty<bool>(); }
            set { SetProperty<bool>(value); if (value) IsVideoPlaying = false; }
        }
        public bool IsVideoPlaying
        {
            get { return GetProperty<bool>(); }
            set { SetProperty<bool>(value); if (value) IsVideoStopped = false; }
        }
        public string PlaybackErrorMessage {
            get { return GetProperty<string>(); }
            set { SetProperty<string>(value); IsPlaybackErrorMessageVisible = !string.IsNullOrWhiteSpace(value); }
        }
        ...
        {
            get { return GetProperty<bool>(); }
            set { SetProperty<bool>(value); if (value) IsVideoInFullscreen = false; }
        }
