...
/// <summary>
/// Tests for the media search/listing endpoint <see cref="ItemsController.Get(long?, int, int, string?, long?)"/>:
...
public class ItemsControllerTests_Search
{
    ...
    public async Task Get_SearchMovies_ReturnsMatchingMovies()
    {
        ...
        var actionResult = await controller.Get(null, 0, 30, "Breaking");
    ...
    public async Task Get_SearchTVShowSeasons_ReturnsMatchingSeasons()
    {
        ...
        var actionResult = await controller.Get(null, 0, 30, "Staffel Eins");
    ...
    public async Task Get_SearchTVShowEpisodes_ReturnsMatchingEpisodes()
    {
        ...
        var actionResult = await controller.Get(null, 0, 30, "Pilotfolge");
    ...
    public async Task Get_Movie_UserHasNoAccess_NotInResults()
    {
        ...
        var actionResult = await controller.Get(null, 0, 30, "Gesperrter Film");
    ...
    public async Task Get_Movie_UserHasUnlockedMovieCollection_IncludedInResults()
    {
        ...
        var actionResult = await controller.Get(null, 0, 30, "Freigeschalteter Film");
    ...
    public async Task Get_TVShowSeasonAndEpisode_UserHasUnlockedTVShow_IncludedInResults()
    {
        ...
        var seasonResult = GetOkValue(await controller.Get(null, 0, 30, "Freigeschaltete Staffel"));
        var episodeResult = GetOkValue(await controller.Get(null, 0, 30, "Freigeschaltete Episode"));
    ...
    public async Task Get_AllTypes_UserNoAccess_ReturnEmptyList()
    {
        ...
        var actionResult = await controller.Get(null, 0, 30, null);
