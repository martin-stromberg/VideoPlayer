...
Branch: `task/issue-220-99c0a1481c9340abb3ee1086374c6498-plattformuebergreifender-backu`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/task/issue-220-99c0a1481c9340abb3ee1086374c6498-plattformuebergreifender-backu/` |
...
| [x] | – | Iteration oder Abschluss entscheiden | Abbruch nach 3 Iterationen, 3 offene Punkte |
