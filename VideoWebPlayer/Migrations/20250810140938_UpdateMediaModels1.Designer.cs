...
namespace VideoWebPlayer.Migrations
{
    ...
    [Migration("20250810140938_UpdateMediaModels1")]
    partial class UpdateMediaModels1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VideoWebPlayer.Data.MediaCollection", b =>
                {
                    ...
                    b.Property<long>("MediaSourceId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VideoWebPlayer.Data.MediaItem", b =>
                {
                    ...
                    b.Property<long>("MediaCollectionId1")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VideoWebPlayer.Data.MediaItem", b =>
                {
                    b.HasOne("VideoWebPlayer.Data.MediaCollection", "MediaCollection")
                        .WithMany("MediaItems")
                        .HasForeignKey("MediaCollectionId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
