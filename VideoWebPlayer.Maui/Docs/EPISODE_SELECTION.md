# Episode Selection & Smart Play Button - Implementation
...
- [ ] App-Start zeigt Serie-Banner ✓
- [ ] Play-Button spielt erste Episode (keine Auswahl) ✓
- [ ] Episode-Auswahl aktualisiert Banner ✓
- [ ] Episode-Auswahl aktualisiert Plot ✓
- [ ] Staffelwechsel wählt erste Episode aus ✓
- [ ] Play-Button spielt ausgewählte Episode ✓
- [ ] Zurück zur Serie zeigt wieder Serie-Banner ✓

## Known Issues

- MediaElement Package-Kompatibilitätsproblem mit .NET 10
- Siehe: MEDIAELEMENT_ERROR_HANDLING.md
